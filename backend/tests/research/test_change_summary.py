...
def test_initial_version_with_data():
    ...
    assert (
        summary
        == "Initial research version: 250 price bar(s) through 2026-01-15, 1 corporate action(s)."
    )
